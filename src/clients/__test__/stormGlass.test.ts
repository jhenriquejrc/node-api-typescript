...
import stormGlassNormalized3HoursNormalizedFixture from '@test/fixtures/stormglass_normalized_response_3_hours.json';
...
describe('StormGlass client', () => {
  ...
  it('should return normalized forecast from the StormGlass service', async () => {
    ...
    expect(response).toEqual(stormGlassNormalized3HoursNormalizedFixture);
  });
  ...
  it('should get StormGlassResponseError when the StormGlass service responds with error', async () => {
    const lat = -33.792726;
    const lng = 151.289824;
